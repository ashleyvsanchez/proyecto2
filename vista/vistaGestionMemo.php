...
<body>
	...
	<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-file-invoice fa-fw"></i> &nbsp; GESTIÓN MEMO
									</h3>
				<p class="text-justify">
					Gestiona la información de los memos  correspondientes. Permitiendo a su vez, crear, consultar y modificar el respectivo documento.
				</p>
			</div>
			...
			<div class="full-box tile-container">
				...
				<a href="vistaCrearMemo.php" class="tile">
					<div class="tile-tittle">Crear Memo</div>
					<div class="tile-icon">
						<i class="fas fa-plus fa-fw"></i><!-- PARA CAMBIAR ICONOS -->
					</div>
                </a>

                <a href="vistaModificarMemo.php" class="tile">
					<div class="tile-tittle">Modificar Memo</div>
					<div class="tile-icon">
						<i class="fas fa-clipboard-list fa-fw"></i>
					</div>
				</a>

				<a href="vistaConsultarMemo.php" class="tile">
					<div class="tile-tittle">Consultar Memo</div>
					<div class="tile-icon">
