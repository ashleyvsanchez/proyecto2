...
<head>
	...
	<title>GESTION SOLICITUD DE SERVICIO SERVICIO </title>
...
<body>
	...
	<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-file-invoice fa-fw"></i> &nbsp; GESTIÓN SOLICITUD DE SERVICIO
									</h3>
				<p class="text-justify">
					Gestiona la información de las solicitudes de servicio correspondientes. Permitiendo a su vez, crear, consultar y modificar el respectivo documento.
				</p>
			</div>
			...
			<div class="full-box tile-container">
				...
				<a href="vistaCrearServicio.php" class="tile">
					<div class="tile-tittle">Crear Servicio</div>
					<div class="tile-icon">
						<i class="fas fa-plus fa-fw"></i><!-- PARA CAMBIAR ICONOS -->
					</div>
                </a>

                <a href="vistaModificarServicio.php" class="tile">
					<div class="tile-tittle">Modificar Servicio</div>
					<div class="tile-icon">
						<i class="fas fa-clipboard-list fa-fw"></i>
					</div>
				</a>

				<a href="vistaConsultarServicio.php" class="tile">
					<div class="tile-tittle">Consultar Servicio</div>
					<div class="tile-icon">
