...
<body>
	...
	<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-store-alt fa-fw"></i> &nbsp; GESTIÓN DE DEPARTAMENTO
				</h3>
				<p class="text-justify">
					Gestiona la información de los departamentos correspondientes. Permitiendo a su vez, crear, consultar y modificar el departamento deseado.
				</p>
			</div>
			...
			<div class="full-box tile-container">
				...
				<a href="vistaCrearDepartamento.php" class="tile">
					<div class="tile-tittle">Crear departamento</div>
					<div class="tile-icon">
						<i class="fas fa-plus fa-fw"></i><!-- PARA CAMBIAR ICONOS -->
					</div>
                </a>

                <a href="vistaModificarDepartamento.php" class="tile">
					<div class="tile-tittle">Modificar departamento</div>
					<div class="tile-icon">
						<i class="fas fa-clipboard-list fa-fw"></i>
					</div>
				</a>

				<a href="vistaConsultarDepartamento.php" class="tile">
					<div class="tile-tittle">Consultar departamento</div>
					<div class="tile-icon">
