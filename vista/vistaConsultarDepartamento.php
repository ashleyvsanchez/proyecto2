...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
        		<form class="form-neon" action="../controlador/controladorConsultarDepartamento.php" method="POST" id="formConsultarDepartamento" >
				<legend><i class="fas fa-store-alt fa-fw"></i> &nbsp; Información importante</legend>
					...
					<div class="container-fluid">
						<div align="center" class="form-group">
							<select class="form-control" name="optDepa" id="optDepa" onchange="mostrarOptDepa()">
								<option value="0" disabled="" selected="">Seleccione una opción</option>
								<option value="1">NOMBRE DEPARTAMENTO</option>
						   ...
						   <?php
                    		...
                    		<div class="col-12 col-md-6">
								<div class="form-group" id="inpNombre" style="display: none">
					...
					<br><br><br>
						...
						<input type="hidden" name="Consultar" value="Consultar" id="Consultar">
	...
	<script src="./js/validarConsultarDepartamento.js"></script>
