...
<body>
		...
		<section class="full-box page-content">
      	...
      	<!-- Page header -->
			...
			<div class="container-fluid">
				<form class="form-neon" action="../controlador/controladorModificarRefrigerio.php" method="POST" id="formRefrigerio" name="formRefrigerio">
						...
						<div class="row justify-content-md-center">
							<div class="col-12 col-md-6">
								<div class="form-group">
									<label for="consultarMemo" class="bmd-label-floating">¿Qué solicitud de refrigerio desea modificar?</label>
									<input type="text" class="form-control" name="ID" id="idr" maxlength="30" onfocusout="validarIDR()">
							...
							<div class="col-12">
								...
								<button type="submit" class="btn btn-raised btn-info btn-sm" name="mconsultarDepartamento" id="mconsultarDepartamento"><i class="far fa-save" name="mconsultarDepartamento"></i> &nbsp; CONSULTAR SOLICITUD DE REFRIGERIO</button>
								</p>
						</div>
					</div>
				</form>
	...
	<script src="./js/vistaModificarRefrigerio.js"></script>
