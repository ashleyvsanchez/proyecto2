...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<form class="form-neon" action="../controlador/controladorModificarDepartamento.php" method="POST" id="formMConsultarDepartamento" name="formMConsultarDepartamento">
				<legend><i class="fas fa-store-alt fa-fw"></i> &nbsp; Información importante</legend>
					...
					<div class="container-fluid">
						<div class="row justify-content-md-center">
                    		...
                    		<div class="col-12 ">
								<div class="form-group" id="inpNombre">
	...
	<script src="./js/validacionModificarDepartamento.js"></script>
