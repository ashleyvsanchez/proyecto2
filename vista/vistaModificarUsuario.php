...
<body>
	...
	<main class="full-box main-container">
		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<form class="form-neon" action="../controlador/controladorModificarUsuario.php" method="post" id="formulario" name="Consultar">
					<div class="container-fluid">
						<div class="row justify-content-md-center">
							...
							<div class="col-12 col-md-6">
								...
								<div class="form-group">
									<label for="inputSearch" class="bmd-label-floating">¿Qué usuario desea modificar?</label>
									<select class="form-control" id="selectNombre" name="nombreUsuario" onchange='validarNombreConsulta()'>
							...
							<div class="col-12">
								<p class="text-center" style="margin-top: 40px;">
									<button type="submit" class="btn btn-raised btn-info" name="consultar"> <i class="fas fa-search"></i> &nbsp; BUSCAR USUARIO</button>
								</p>
							</div>
						</div>
					</div>
	...
	<script src="./js/validarModificarUsuario.js"></script>
