...
<section class="full-box page-content">
		...
		<form action="../controlador/controladorConsultarPersona.php" method="POST" class="form-neon" id="Form">
		...
		<input type="hidden" class="form-control" name="rol" id="rol"   value="<?php echo $_SESSION['rol']; ?>">
            <div class="container-fluid">
				<div class="form-group">
					<select class="form-control" name="optConPer" id="optConPer" onchange="mostrarOptPer()">
                        ...
                        <option value="4">Mostrar todas las personas</option>
                    </select>
                ...
                <div class="row justify-content-md-center">
                    ...
                    <div class="col-12 col-md-6">
                        <div class="form-group" id="inpCed" style="display: none">
                            <label for="inputSearch" class="bmd-label-floating">Introduzca cédula de la persona a buscar</label>
                            <input type="text" value="" class="form-control" name="Cédula" id="conCed" maxlength="30" onfocusout="validarCedula()">
                            <span class="helper-text"></span>
						</div>
					
						<div   class="form-group" id="inpCar" style="display: none">
                            <select class="form-control" name="Cargo" id="conCargo">
					 ...
					 if($_SESSION['rol']== 'Administrador'){
						...
						echo ' 
							<div   class="form-group" id="inpDep" style="display: none">
						...
						echo '<input type="hidden" name="Departamento"  value="">';
					}
					 ?>
	...
	<script src="./js/vistaConsultarPersona.js"></script>
