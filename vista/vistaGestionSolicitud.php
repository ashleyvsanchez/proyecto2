...
<body>
	...
	<section class="full-box nav-lateral">
		...
		<section class="full-box page-content">
            ...
            <a href="./vistaGestionServicio.php" class="tile" id="gSolicitud">
					<div class="tile-tittle">Sol. de servicio</div>
					<div class="tile-icon">
						<i class="fas fa-file-invoice fa-fw"></i>
					</div>
				</a>

				<a href="./vistaGestionRefrigerio.php" class="tile" id="gSolicitud">
					<div class="tile-tittle">Sol. de refrigerio</div>
					<div class="tile-icon">
						<i class="fas fa-file-invoice fa-fw"></i>
					</div>
				</a>
