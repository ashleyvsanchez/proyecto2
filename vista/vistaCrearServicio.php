...
<body>
	...
	<section class="full-box nav-lateral">
		...
		<section class="full-box page-content">
          ...
          <div class="full-box page-header">
            <h3 class="text-left">
                <i class="fas fa-plus fa-fw"></i> &nbsp; CREAR SOLICITUD DE SERVICIO
            </h3>
        ...
        <div class="container-fluid">
            <form action="../controlador/controladorCrearServicio.php" method="POST" class="form-neon" name="formCrearServicio" id="formCrearServicio">
			...
			<input type="hidden" class="form-control" name="departamento" id="departamento"  maxlength="70" value="<?php echo $_SESSION['departamento_usuario']; ?>">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-5">
                                <div class="form-group">
                                    <label for="TRABAJO A REALIZAR" class="bmd-label-floating">TRABAJO A REALIZAR</label>
                                    <input type="text" class="form-control" name="trabajo" id="Trabajo a realizar"  maxlength="40"  onfocusout="validartrabajo()">
                            ...
                            <div class="col-12 col-md-5">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="lugar" id="Lugar"  maxlength="25"  onfocusout="validarlugar()">
                                    <span class="helper-text"></span>
                                </div>
                            ...
                            <div class="col-11">
                                <div class="form-group">
                                    <label for="DESCRIPCION DEL TRABAJO" class="bmd-label-floating">DESCRIPCIÓN DEL TRABAJO</label>
                                    <input type="text" class="form-control" name="DT" id="Descripcion del trabajo"  maxlength="40"  onfocusout="validarDT()">
                                    <span class="helper-text"></span>
                                </div>
							</div>
							<div class="col-12 col-md-1">
                ...
                <p class="text-center" style="margin-top: 40px;">
                    ...
                    <button type="submit" class="btn btn-raised btn-info btn-sm"><i class="far fa-save" name="crearDepartamento"></i> &nbsp; CREAR SOLICITUD DE SERVICIO</button>
    ...
    <script src="./js/vistaCrearServicio.js"></script>
