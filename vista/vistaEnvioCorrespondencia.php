...
<title>ENVIO CORRESPONDENCIA</title>
...
<main class="full-box main-container">
    ...
    <section class="full-box page-content">
        ...
        <div class="full-box page-header">
            <h3 class="text-left">
                <i class="fas fa-plus fa-fw"></i> &nbsp; ENVIAR CORRESPONDENCIA
            </h3>
        ...
        <div class="container-fluid">
            <form action="../controlador/controladorEnvioCorrespondencia.php" method="POST" class="form-neon" name="Envio" id="formulario">
                    ...
                    <div class="container-fluid">
                        <div class="row">
                            <?php
								...
								$idDepartamento = $dep -> consultarNombreDepartamento();

                                $Departamentos = $dep->consultarDepartamento();

                                $m = new memo(null,null,null,null,null,null,null,null,null,null,$idDepartamento['idd']);
                                $Memo = $m -> consultarDocumentoMemo();

                                $s = new servicio(null,null,null,null,null,null,null,$idDepartamento['idd'],null,null,null,null);
                                $Servicio = $s->consultarDocumentoServicio();

                                $r = new refrigerio(null,null,null,null,null,null,null,$idDepartamento['idd']);
                                $Refrigerio = $r->consultarDocumentoRefrigerio();
                        ...
                        <div class="col-12 col-md-5" >
                            <div class="form-group">
                                <select class="form-control" id="Destino" name="para" onchange='validarPara()'>
                                    <option value="0" disabled  selected="">Departamento Destino </option>

                                    <?php
                                        while($row=pg_fetch_array($Departamentos)){
                                            if($_SESSION['departamento_usuario']!=$row['nombred'])
                                            
                                            echo "<option value =".$row['nombred'].">".$row["nombred"]."</option>";
                                        }
                                    ?>
                                    
                                    </select>
                                    <span class="helper-text" id="textDestino"></span>
                                </div>
                            </div>
                            ...
                            <div class="col-12 col-md-5" >
                                <div class="form-group">
                                    <label for="idDepartamento" class="bmd-label-floating">Asunto</label>
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 col-md-5" >
                                <div class="form-group">
                                    <textarea name="Mensaje" id="Mensaje" class="form-control" rows="5" cols="20" placeholder=" Mensaje" onfocusout="validarMensaje()"></textarea>
                                    <span class="helper-text"></span>
                                </div>
                            </div>
                        ...
                        <div class="col-12 col-md-5">
                            <h5 align="center">Seleccione Tipo de documento</h5>
                            <table class='table table-sm'>
                                <tr>
                                    <td align='center' width=400><input  id='optMemo'       name="TipoDoc" type="radio" value ="1" onchange='mostrarMemos()'>Memo</td>
                                    <td align='center' width=400><input  id='optServicio'   name="TipoDoc" type="radio" value ="2" onchange='mostrarServicios()'>Servicio</td>
                                    <td align='center' width=400><input  id='optRefrigerio' name="TipoDoc" type="radio" value ="3" onchange='mostrarRefrigerios()'>Refrigerio</td>
                                </tr>
                            </table>        
                        </div>
                       ...
                       <div class='row'>
                            ...
                            <legend  style='display: none' id="tituloDoc"><i class="fas fa-user-lock"></i> &nbsp; Seleccione el Documento a enviar</legend>

                        
                                <div class="col-12 col-md-12"  id="Memos" style="display: none">
                                        <select class="form-control" name="Memo" id="selectMemos" >
                                            <option value="0" disabled  selected="" >Memos</option>

                                            <?php
                                                    while($row=pg_fetch_array($Memo)){
                                                        echo "<option value =".$row['iddoc'].">".$row['asunto']."</option>";
                                                    }
                                            ?>
                                        </select>
                                        <span class="helper-text" id='textMemo'></span>
                                </div>

                                <div class="col-12 col-md-12"  id="Servicios" style="display: none">
                                        <select class="form-control" name="Servicio" id="selectServicios" >
                                            <option value="0" disabled  selected="" >Servicios</option>

                                            <?php
                                                    while($row=pg_fetch_array($Servicio)){
                                                        echo "<option value =".$row['iddoc'].">"."Trabajo: ".$row['trabajo']." --- Fecha: ".$row['fechad']."</option>";
                                                    }
                                            ?>
                                        </select>
                                        <span class="helper-text" id='textServicio'></span>
                                </div>


                                <div class="col-12 col-md-12"  id="Refrigerios" style="display: none">
                                        <select class="form-control" name="Refrigerio" id="selectRefrigerios" >
                                            <option value="0" disabled  selected="" >Refrigerios</option>

                                            <?php
                                                    while($row=pg_fetch_array($Refrigerio)){
                                                        echo "<option value =".$row['iddoc'].">"."Evento: ".$row['cursoevento']." --- Fecha: ".$row['fechad']."</option>";
                                                    } 
                                            ?> 
                                        </select>
                                        <span class="helper-text" id='textRefrigerio'></span>
                                    </div> 
                                </div>        
                ...
                <p class="text-center" style="margin-top: 40px;">
                    ...
                    <button type="submit" class="btn btn-raised btn-info btn-sm"><i class="far fa-save" name="enviarCorrespondencia"></i> &nbsp; ENVIAR CORRESPONDENCIA</button>
...
<script src="./js/validarEnvioCorrespondencia.js"></script>
