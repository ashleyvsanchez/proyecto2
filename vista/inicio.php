	...
	<section class="full-box nav-lateral">
				...
				<nav class="full-box nav-lateral-menu">
					...
					<ul>
						...
						<li id="estatus"  style="display: none">
							<a href="vistaEstatusSolicitud"><i class="fas fa-file-import fa-fw"></i> &nbsp; Estatus de solicitud</a>
						</li>


						<li id="cambioImagen" style="display: none" >
							<a href="vistaMembrete.php"><i class="fas fa-file-import fa-fw"></i> &nbsp; Membrete</a>
						</li>
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fab fa-dashcube fa-fw"></i> &nbsp; SISTEMA ENVIO Y RECEPCIÓN DE CORRESPONDENCIA
				</h3>
				<p class="text-justify">
					Sistema de intercambio de correspondencia interna y creación de documentos.
				</p>
			</div>
			...
			<div class="full-box tile-container">
				...
				<a href="./vistaGestionUsuario.php" class="tile" id="gUsuario"  style="display: none">
					<div class="tile-tittle">Gestión de usuario</div>
					<div class="tile-icon">
						<i class="fas fa-users fa-fw"></i> <!-- PARA CAMBIAR ICONOS -->
					</div>
				</a>

				<a href="./vistaGestionPersona.php" class="tile" id="gPersona">
					<div class="tile-tittle">Gestión de persona</div>
					<div class="tile-icon">
						<i class="fas fa-user fa-fw"></i>
					</div>
				</a>

				<a href="./vistaGestionDepartamento.php" class="tile" id="gDepartamento">
					<div class="tile-tittle">Gestión departamento</div>
					<div class="tile-icon">
						<i class="fas fa-store-alt fa-fw"></i>
					</div>
				</a>

				<a href="./vistaGestionMemo.php" class="tile" id="gMemo">
					<div class="tile-tittle">Gestión de memos</div>
					<div class="tile-icon">
						<i class="fas fa-file-invoice fa-fw"></i>
					</div>
				</a>

				<a href="./vistaGestionSolicitud.php"  class="tile" id="gSolicitud">
					<div class="tile-tittle">Gestión de solicitud</div>
					<div class="tile-icon">
						<i class="fas fa-file-invoice fa-fw"></i>
					</div>
				</a>
