...
<head>
	...
	<title>GESTION SOLICITUD DE SERVICIO REFRIGERIO </title>
...
<body>
	...
	<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-file-invoice fa-fw"></i> &nbsp; GESTIÓN SOLICITUD DE REFRIGERIO
									</h3>
				<p class="text-justify">
					Gestiona la información de las solicitudes de refrigerio correspondientes. Permitiendo a su vez, crear, consultar y modificar el respectivo documento.
				</p>
			</div>
			...
			<div class="full-box tile-container">
				...
				<a href="vistaCrearRefrigerio.php" class="tile">
					<div class="tile-tittle">Crear Refrigerio</div>
					<div class="tile-icon">
						<i class="fas fa-plus fa-fw"></i><!-- PARA CAMBIAR ICONOS -->
					</div>
                </a>

                <a href="vistaModificarRefrigerio.php" class="tile">
					<div class="tile-tittle">Modificar Refrigerio</div>
					<div class="tile-icon">
						<i class="fas fa-clipboard-list fa-fw"></i>
					</div>
				</a>

				<a href="vistaConsultarRefrigerio.php" class="tile">
					<div class="tile-tittle">Consultar Refrigerio</div>
					<div class="tile-icon">
