<?php
	...
	$refrigerio= new refrigerio(null,null,null,null,null,null,null,null,null); // instanciamos
...
<body>
	...
	<section class="full-box nav-lateral">
		...
		<section class="full-box page-content">
			...
			<div class="container-fluid">
				<form class="form-neon" action="../controlador/controladorConsultarRefrigerio.php" method="POST" id="formConsultarRefrigerio" >
				<input type="hidden" class="form-control" name="departamento" id="departamento"  maxlength="70" value="<?php echo $_SESSION['departamento_usuario']; ?>">
            		<div class="container-fluid">
						<div class="form-group">
							<select class="form-control" name="optRefrigerio" id="optRefrigerio" onchange="mostrarOptRefrigerio()">
								<option value="0" selected="">Seleccione una opción</option>
								<option value="1">ID</option>
								<option value="2">FECHA</option>
								<option value="3">NOMBRE DEL CURSO O EVENTO</option>
               			...
               			<div class="row justify-content-md-center">
                    		...
                    		<div class="col-12 col-md-6">
								...
								<label for="inputSearch" class="bmd-label-floating"> ID</label>
									<input type="text" class="form-control" name="ID" id="IDR" maxlength="50" onfocusout="validarCursoEvento()">
                           			 <span class="helper-text"></span>
								</div>
						
                        		<div class="form-group" id="inpFecha" style="display: none">
                           		
									   <select class="form-control" id="fecha" name="fecha" onfocusout="validarFecha()">
											<option value="0"  selected="">Seleccione Servicio </option>

											<?php
												
												$result = $refrigerio->consultarFechaRefrigerioVista($depid);
								...
								<div class="form-group" id="inpCursoEvento" style="display: none">
                           			<label for="inputSearch" class="bmd-label-floating"> NOMBRE DEL CURSO O EVENTO </label>
									<input type="text" class="form-control" name="cursoevento" id="cursoevento" maxlength="50" onfocusout="validarCursoEvento()">
                            		<span class="helper-text"></span>
								</div>
	...
	<script src="./js/vistaConsultarRefrigerio.js"></script>
