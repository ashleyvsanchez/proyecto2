...
<body>
	...
	<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-users fa-fw"></i> &nbsp; GESTIÓN DE USUARIO
				</h3>
				<p class="text-justify">
					Gestiona la información de las usuarios correspondientes. Permitiendo a su vez, crear, consultar y modificar el respectivo usuario.
				</p>
			</div>
			...
			<div class="full-box tile-container">
				...
				<a href="vistaCrearUsuario.php" class="tile">
					<div class="tile-tittle">Crear Usuario</div>
					<div class="tile-icon">
						<i class="fas fa-plus fa-fw"></i><!-- PARA CAMBIAR ICONOS -->
					</div>
                </a>

                <a href="vistaModificarUsuario.php" class="tile">
					<div class="tile-tittle">Modificar Usuario</div>
					<div class="tile-icon">
						<i class="fas fa-clipboard-list fa-fw"></i>
					</div>
				</a>

				<a href="vistaConsultarUsuario.php" class="tile">
					<div class="tile-tittle">Consultar Usuario</div>
					<div class="tile-icon">
