...
<body>
	...
	<section class="full-box nav-lateral">
        ...
        <div class="full-box page-header">
			...
			<div class="container-fluid">
        		<form class="form-neon" action="../controlador/controladorConsultarServicio.php" method="POST" id="formConsultarServicio" >
				<input type="hidden" class="form-control" name="departamento" id="departamento"  maxlength="70" value="<?php echo $_SESSION['departamento_usuario']; ?>">
            		<div class="container-fluid">
						<div class="form-group">
							<select class="form-control" name="optServicio" id="optServicio" onchange="mostrarOptServicio()">
								<option value="0" selected="">Seleccione una opción</option>
								<option value="1">ID</option>
								<option value="2">FECHA</option>
								<option value="4">TRABAJO A REALIZAR</option>
               			...
               			<div class="row justify-content-md-center">
                    		...
                    		<div class="col-12 col-md-6">
								...
								<select class="form-control" id="IDS" name="ID" onfocusout="validarID()">
											<option value="0"  selected="">Seleccione Número de Solicitud </option>
											...
											<?php
												...
												while($row=pg_fetch_array($result)){
													...
													echo "<option value =".$row['nos'].">".$row["nos"]."</option>";
												}
											?>	
                                    </select>
                           			 <span class="helper-text"></span>
                        		...
                        		<div class="form-group" id="inpFecha" style="display: none">
									   <select class="form-control" id="fecha" name="fecha" onfocusout="validarFecha()">
											...
											<?php
												...
												$result = $servicio->consultarFechaServicioVista($depid);
								...
								<div class="form-group" id="inpDepa" style="display: none">
                           			<label for="inputSearch" class="bmd-label-floating"> DEPARTAMENTO DE ADSCRIPCION</label>
									   <select class="form-control" id="depads" name="depads" onfocusout="validardepads()">
									    <option value="0" selected="">Seleccione una opción</option>
								...
								<div class="form-group" id="inpTrabajo" style="display: none">
                           			<label for="inputSearch" class="bmd-label-floating"> TRABAJO A REALIZAR </label>
									<input type="text" class="form-control" name="trabajo" id="trabajo" maxlength="50" onfocusout="validartrabajo()">
                            		<span class="helper-text"></span>
								</div>
                    	...
                    	<div class="col-12">
                       		<p class="text-center" style="margin-top: 40px;">
                            	<button type="submit" class="btn btn-raised btn-info" ><i class="fas fa-search" ></i> &nbsp; CONSULTAR</button>
                       		 </p>
                   		</div>
               		</div>
        		</form>
    ...
    <script src="./js/vistaConsultarServicio.js"></script>
