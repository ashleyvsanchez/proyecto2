...
<head>
	...
	<title>GESTION DE PERSONA</title>
...
<body>
	...
	<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fab fa-dashcube fa-fw"></i> &nbsp; GESTIÓN DE PERSONA
				</h3>
				<p class="text-justify">
					Gestiona la información de las personas correspondientes. Permitiendo a su vez, crear, consultar y modificar la respectiva persona.
				</p>
			</div>
			...
			<div class="full-box tile-container">
				...
				<a href="vistaCrearPersona.php" class="tile">
					<div class="tile-tittle">Crear persona</div>
					<div class="tile-icon">
						<i class="fas fa-user fa-fw"></i> <!-- PARA CAMBIAR ICONOS -->
					</div>
                </a>

                <a href="vistaModificarPersona.php" class="tile">
					<div class="tile-tittle">Modificar persona</div>
					<div class="tile-icon">
						<i class="fas fa-clipboard-list fa-fw"></i>
					</div>
				</a>

				<a href="vistaConsultarPersona.php" class="tile">
					<div class="tile-tittle">Consultar persona</div>
					<div class="tile-icon">
