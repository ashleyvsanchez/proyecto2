	...
	<section class="full-box nav-lateral">
		...
		<!-- Page content -->
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fab fa-dashcube fa-fw"></i> &nbsp; CREAR SOLICITUD DE SERVICIO
				</h3>
...
/*Incluimos la clase SERVICIO para poder registrar los datos*/
include_once ('../modelo/claseServicio.php'); 
...
$servicio = new servicio(null,$fecha,$estatus,$cedula,null,$idimg,null,$DA,$TA,$LU,$DT);


$result=$servicio->crearServicio();
...
echo"
                    ...
                    .then(resultado => {
                        if(resultado.value) {
                            window.location.href='../vista/vistaCrearServicio.php';
                        }
                    });
