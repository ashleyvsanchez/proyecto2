...
<body>
	...
	<section class="full-box nav-lateral">
		...
		<section class="full-box page-content">
			...
			<div class="full-box page-header">
				<h3 class="text-left">
					<i class="fas fa-clipboard-list fa-fw"></i> &nbsp; MODIFICAR USUARIO
				</h3>
				<p class="text-justify">
					Permite modificar los datos del usuario solicitado.
				</p>
			</div>
    ...
    <?php
        include("../modelo/claseUsuario.php");
            ...
            $nombreActual = $_POST['nombreUsuario'];
        
			$c = new usuario(null,null,$nombreActual,null,null);
			
			$cedulaUsuario = $c -> reporteEspecifico();
                ...
                ?>
                    <script>
                       /* Swal.fire({
                            ...
                            html: 'El Nombre de usuario consultado no existe',
                            icon: 'error',
                        ...
                        .then(resultado=>{
                            if(resultado.value){
                                window.location.href='../vista/vistaModificarUsuario.php';
                            }
                        }) ; */
	...
	<div class='container-fluid'>
		...
		<table class='table table-dark table-sm'>
			<tr>
				<td align='center' width=400><input type="checkbox" id="checkNomU" onchange="mostrarNom()"> Nombre de usuario</td>
				<td align='center' width=400><input type="checkbox" id="checkClave" onchange="mostrarClave()"> Clave</td>
				<!--<td align='center' width=400><input type="checkbox" id="checkCed" onchange="mostrarCed()"> Cedula </td>-->
				<td align='center' width=400><input type="checkbox" id="checkRol" onchange="mostrarRol()"> Rol </td>
				</td>
			</tr>
		</table>
	</div>
    ...
    <form action="controladorModificarUsuario.php" method="POST" class="form-neon" autocomplete="off" id="formulario" name="Modificar">    
                <legend><i class="fas fa-user-lock"></i> &nbsp; Datos Personales</legend>
                <div class="row">
                    <div class="col-12 col-md-6"  id="modNomU" style="display: none">
                        <div class="form-group">
                            <label for="Nom" class="bmd-label-floating">Nombre de Usuario</label>
                            <input type="text" class="form-control" name="Nombre" id="modNombre" maxlength="35" onfocusout="validarNombre();">
                            <span class="helper-text"></span>
                        </div>
                    </div>
                    
                    <div class="col-12 col-md-6"   id="modClave" style="display: none">
                        <div class="form-group">
                            <label for="Clave" class="bmd-label-floating">Clave</label>
                            <input type="password" class="form-control" name="Clave" id="Clave" maxlength="35" onfocusout="validarClave();">
                            <span class="helper-text"></span>
                        </div>
                    </div>


					<div class="col-12 col-md-6"  id="modClaveRep" style="display: none">
                        <div class="form-group">
                            <label for="ClaveRepetir" class="bmd-label-floating">Repetir Clave</label>
                            <input type="password" class="form-control" name="Repetir Clave" id="ClaveRep" maxlength="35" onfocusout="validarRepetirClave();">
                            <span class="helper-text"></span>
                        </div>
                    </div>
                ...
                <div class="row">
                    <div class="col-12 col-md-6"  id="modRol" style="display: none">
                            ...
                            <span class="helper-text" id="textRol" ></span>
                     </div>
				...
				<input type="hidden" name="Enviar" value="Enviar" id="Envio">
			 	...
			 	<?php echo "<input type='hidden' name='nombreUsuario' id='NombreUsuario' value='".$nombreActual."'>";?> 
        ...
        <p class="text-center" style="margin-top: 40px;">
            ...
            &nbsp; &nbsp;
            <button type="submit" name="guardar" class="btn btn-raised btn-info btn-sm" ><i class="far fa-save"></i> &nbsp; GUARDAR</button>
		</p>
    </form>
		...
		<?php 
			...
			if(isset($_POST['Enviar']))
			{
				...
				//inicializo la variable rol
				$rol = 0;

				//verifico si el campo de rol está vacío o no
				if(isset($_POST['Rol']))
				 $rol= $_POST['Rol'];
				
				
 				//Este es para verificar si el nombre se va a modificar
				if($nombreModificado != "")
				{	
		
					 $c= new usuario(null,null,$nombreModificado,null,null);
					...
					if($c->validarUsuario() == true)
					{
						...
						?>
							...
							<script>
									Swal.fire({
										title: ' ¡Error! ',
										html: 'Nombre de usuario ya existe',
										icon: 'error',
										showConfirmButton: true,
				    ...
				    {
						$c= new usuario(null,null,$nombreActual,null,null);
						$c -> modificarNombre($nombreModificado);
						
						?>
						<script>
							Swal.fire({
								title: ' ¡MODIFICACIÓN EXITOSA! ',
								html: 'Modificación de usuario exitosa',
								icon: 'info',
								showConfirmButton: true,
 ...
 //Este es para verificar si la clave se va a modificar

				if($clave != "")
				{
					 $c= new usuario(null,null,$nombreActual,null,null);

					 $c -> modificarClave($clave);
			...
			//Este valida si selecciona o no la modificacion del Rol (Aunque tengo un problemita que muestra que está vacio cuando no se selecciona)
				if($rol != 0)
				{
					  $c= new usuario(null,null,$nombreActual,null,null);
					  $cedulaUsuario = $c -> reporteEspecifico();
					if(($c -> validarRol($cedulaUsuario[2]) == true) && ($rol == 2))
					{
							?>
								<script>
									Swal.fire({
										title: ' ¡Error! ',
										html: 'Ya existe Jefe de departamento',
										icon: 'error',
										showConfirmButton: true,
										confirmButtonText: 'Volver a intentar',
									})
		...
		//Este es el mensaje de modificacion exitosa
