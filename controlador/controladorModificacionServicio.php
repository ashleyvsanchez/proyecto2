      ...
      <!-- Content -->
        ...
        //--------Consultamos la solicitud de servicio--------//
				...
				if($_POST['modificar']){ // verificamos el formulario por el input escondido
					...
					if(($_POST['trabajo'] != "") && ($_POST['lugar'] != "") && ($_POST['DT'])){
				


						//MODIFICAMOS LOS DATOS DEL SERVICIO

						$servicio= new servicio(null,null,null,null,null,null,$_POST['IDS'],null,$_POST['trabajo'],$_POST['lugar'],$_POST['DT'],null); // instanciamos


						$result=$servicio->modificarServicio(); // hacemos el llamado al método
